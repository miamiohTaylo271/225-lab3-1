...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/taylo271:latest'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamiohTaylo271/225-lab3-1.git'                   // <------change this
        KUBECONFIG = credentials('taylo271-225')                                             // <------change this
    }
